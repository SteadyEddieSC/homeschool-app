...
test('loads the synthetic v10.34 release', async ({ page }) => {
  await page.goto('/');
  ...
  await expect(page.locator('html')).toHaveAttribute('data-release', 'v10.34');
  await expect(page.locator('html')).toHaveAttribute('data-route-contract', 'v10.34');
  ...
  await expect(page.locator('.v25-title')).toHaveAttribute('data-blh-hero-owner', 'BLHHero@v10.34');
